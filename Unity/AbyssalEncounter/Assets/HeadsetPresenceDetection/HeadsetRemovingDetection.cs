...
{
    // use of OVRManager.instance.isUserPresent is only possible by importing the Oculus package.
    ...
    void Start()
    {
        ...
        else
        {
            ...
            headset.TryGetFeatureValue(CommonUsages.userPresence, out headsetIsOn);
        }
    }
    ...
    void Update()
    {
        ...
        headset.TryGetFeatureValue(CommonUsages.userPresence, out userPresence);
